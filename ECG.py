...
import csv #taking values as input
import math 
import pandas as pd # for working with datasets
import numpy as np  # for working with arrays
import matplotlib.pyplot as plt # for plotting
# Helps to obtain the FFT
import scipy.fftpack    #fft is used for converting from time domain to freq domain
...
T = 1.0 / Fs
#Compute x-axis
x = np.linspace(0.0, N*T, N) #linspace is used for evenly spaced seq in specified interval
